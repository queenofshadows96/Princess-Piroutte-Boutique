...
export default function Checkout() {
  ...
  const orderTotal = safeSubtotal + shipping;
  ...
  if (totalItems === 0) {
    return (
      <main className="relative z-10 min-h-screen flex items-center justify-center px-6 py-20">
        ...
        >
          <h1
            className={`${magnolia.className} text-3xl font-bold mt-5 mb-3`}
            style={{ color: ROSE }}
          >
            Your Cart is Empty
          </h1>
  ...
  return (
    <main className="relative z-10 py-16 px-6 min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1
            className={`${magnolia.className} text-4xl md:text-5xl font-bold mt-3`}
            style={{ color: ROSE }}
          >
            Complete Your Order
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8 items-start">
          ...
          >
            <h2
              className={`${magnolia.className} text-2xl font-bold tracking-widest mb-5`}
              style={{ color: GOLD }}
            >
              Shipping Details
            </h2>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setForm((prev) => ({ ...prev, giftMessage: e.target.value }))
                }
                rows={3}
                className="w-full px-4 py-3 rounded-xl text-sm outline-none"
                style={{
            ...
            <div className="mb-6 flex items-center gap-2">
              ...
              <label
                ...
                style={{ color: ROSE }}
              >
                This is a gift — hide prices on the packing slip
              </label>
            </div>
            ...
            <p
              ...
              style={{ color: "#B8A0A8" }}
            >
              <Lock size={12} /> You will be redirected to Stripe's secure
              payment page
            </p>
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              <AnimatePresence>
                {items.map((item) => (
                  <motion.div
                    key={`${item.id}-${item.size}-${item.colorId}`}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="flex-1 min-w-0">
                        <p
                          className={`${magnolia.className} text-sm font-bold leading-tight truncate`}
                          style={{ color: ROSE }}
                        >
                          {item.name}
                        </p>
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            removeFromCart(item.id, item.size, item.colorId)
                          }
            ...
            >
              ...
              <div className="flex justify-between font-bold">
                <span className={magnolia.className} style={{ color: ROSE }}>
                  Total
                </span>
                <span
                  className={`${magnolia.className} text-lg`}
                  style={{ color: GOLD }}
                >
            ...
            <button
              ...
              style={{
                background:
                  "linear-gradient(135deg, #D4A853 0%, #C9A84C 50%, #B8943E 100%)",
                color: "#fff",
